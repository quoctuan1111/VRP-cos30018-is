...
class DataProcessor:
    ...
    def _create_distance_matrix(self) -> None:
        ...
        # Second pass: ensure all distances are reasonable
        max_reasonable_distance = 2000  # 2000 km
        self.distance_matrix = np.minimum(self.distance_matrix, max_reasonable_distance)
